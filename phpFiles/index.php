...
<div class="avatar-container">
            <img src="Animal1.jpg" alt="Animal Avatar" id="avatar" class="avatar">
...
<div class="avatar-container1">
            <img src="tom.jpg" alt="Animal Avatar" id="avatar1" class="avatar">
            <div class="eyes" id="left-eye1"></div>
            <div class="eyes" id="right-eye1"></div>
        </div>
<h3> Admin Login </h3>
<form action="loginadmin1_server_page.php" method="get">
<div class="form-group">
<input type="text" class="form-control" name="login_email" placeholder="Enter your Email" oninput="handleInput1('email')" required>
</div>
<div>
<br>
<br>
...
<div class="form-group">
<input type="password" class="form-control" name="login_password" placeholder="Enter your password" oninput="handleInput1('password')" required>
</div>
...
function handleInput1(inputType) {
    const leftEye = document.getElementById('left-eye1');
    const rightEye = document.getElementById('right-eye1');
